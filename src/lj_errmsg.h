...
ERRDEF(XEXPR,	LUA_QL("expr") " expected")
ERRDEF(XFVAR,	"assign a final variable")
ERRDEF(XFUPVAR,	"assign a final upvar")
ERRDEF(XSYMBOL,	"unexpected symbol")
ERRDEF(XDOTS,	"cannot use " LUA_QL("!vararg") " outside a vararg function")
